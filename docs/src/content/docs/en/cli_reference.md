...
| `enable_dsa_multi_stream` | `bool` | `false` | Enable NPU dual-stream overlap between the lightning indexer and DSA attention projections for the Python GLM-5.2 model. |
