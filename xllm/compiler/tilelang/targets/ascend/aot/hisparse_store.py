...
from xllm.python.kernels_npu.tilelang import hisparse_store as kernel_impl
...
@register_kernel
class HisparseStoreKernel(TilelangKernel):
    KERNEL_NAME = "hisparse_store"
    ...
    def generate_source(head_dim: int) -> str:
        ...
        program = kernel_impl.build_hisparse_store_kernel(head_dim, tilelang_utils.detect_vec_core_num())
