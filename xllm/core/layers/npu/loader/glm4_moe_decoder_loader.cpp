...
void Glm4MoeDecoderLoader::resize_experts_weights(
...
int32_t Glm4MoeDecoderLoader::extract_expert_index(const std::string& name) {
...
int32_t Glm4MoeDecoderLoader::get_mapped_index(
    const std::string& name,
